...
public class PaintCalculation {
	...
	public static void main(String[] args) {
		...
		double surfaceArea;
		System.out.println("Please enter the width, length,"
				+ "and height of the house to be painted");
		...
		surfaceArea=(w*h*2+l*h*2)-(numWin * winWidth * winHeight+ numDoors * 
				doorWidth*doorHeight);
		System.out.println("The total paintable surface are is: "+ surfaceArea);
	}
